...
export default [
    new ProjectData("project-8", "Sultans Of Sing", "img/projects/project-6-icon.png", `
    <div class="paragraph">
    ...
    new ProjectData("project-9", "The Art of Walking", "img/projects/project-8-icon.png", `
    <div class="paragraph">
    ...
    new ProjectData("project-10", "Nikolable", "img/projects/project-9-icon.png", `
     <div class="paragraph">
